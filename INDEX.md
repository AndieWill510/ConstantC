...
- [`collab/2026-08-05-producer-conduct-intelligence/README.md`](./collab/2026-08-05-producer-conduct-intelligence/README.md) — accessible source for the Producer Conduct Intelligence working paper; includes the strategic framing, methodological boundaries, production path, and both anonymized network figures.
- [`collab/2026-08-05-producer-conduct-intelligence/producer_conduct_network_schematic_organization.svg`](./collab/2026-08-05-producer-conduct-intelligence/producer_conduct_network_schematic_organization.svg) — public-safe organization-centered severe-outcome traceability schematic.
- [`collab/2026-08-05-producer-conduct-intelligence/producer_conduct_network_schematic_producer.svg`](./collab/2026-08-05-producer-conduct-intelligence/producer_conduct_network_schematic_producer.svg) — public-safe producer-centered longitudinal escalation schematic.
- [`collab/2026-08-05-producer-conduct-intelligence/ASSET-MANIFEST.md`](./collab/2026-08-05-producer-conduct-intelligence/ASSET-MANIFEST.md) — target paths and checksums for the publication PDF and screenshot-level anonymized PNG derivatives.
...
43. [`sessions/2026-08-05-session-023-producer-conduct-intelligence.md`](./sessions/2026-08-05-session-023-producer-conduct-intelligence.md) — applied oversight case: reframing a scorecard and graph into a governed, evidence-linked, contestable review capability.

## Handoff Lanes

44. [`inbox/to-c.md`](./inbox/to-c.md) — current Producer Conduct Intelligence review packet for C.
...
### To understand Producer Conduct Intelligence

Read Session 023, the collaborative working-paper source, `canon/unlost-systems-principles.md`, `culture/anti-premature-certainty.md`, and `culture/cognitive-load-as-governance.md`.

The working paper is an applied artifact, not canon. Its central claim is that the scorecard, graph, and model are instruments inside a governed oversight capability that can show its work.
